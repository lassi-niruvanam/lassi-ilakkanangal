...
export default function நிரல்மொழிகள் () => {
    Object.keys(_மொழி_தகவல்கள்)
}

export default function தகவல் (நிரல்மொழி, மொழி, ) => {
    Object.keys(_மொழி_தகவல்கள்)
}


JSON.parse(fs.readFileSync('student.json');)
