...
export class லஸ்ஸி_இலக்கணங்கள் {
  ...
  நிறைவு({
    ...
    if (!மொழி) {
      const மூல்_மொழி = this.மூல்_மொழி({நிரல்மொழி})
      const மொழிகள் = this.இயற்கை_மொழிகள்({நிரல்மொழி}).filter(மொ => மொ !== மூல்_மொழி);
      if (மொழிகள்.length === 0) return 0
    ...
    பதிப்பு = பதிப்பு || this.பதிப்பு_கண்டறி({ நிரல்மொழி });
    const விதி_நிரல்மொழி = this.விதிகள்({ நிரல்மொழி, பதிப்பு }).filter(விதி => 
      this._மொழிபெயர்ப்புகள்[நிரல்மொழி]?.விதிகள்[விதி]?.தேவை !== false);
