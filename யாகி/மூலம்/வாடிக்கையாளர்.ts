...
import {
  மொழி_தகவல்கள்,
  மொழி_மொழிபெயர்ப்புகள்
} from "@/நிரல்மொழிகள்.js"

export class இலக்கணங்கள் {
  ...
  get நிரல்மொழிகள்(): string[] {
    return Object.keys(this._இலக்கணங்கள்)
  }

  பதிப்பு_கண்டறி({நிரல்மொழி}: {நிரல்மொழி: string}): string {
    return sort(Object.keys(this._இலக்கணங்கள்[நிரல்மொழி].பதிப்பு))[-1]
  }
  ...
  நிறைவு({
    ...
    if (மொழி === this._இலக்கணங்கள்[நிரல்மொழி].மொழி) {
        return 1
    }
    பதிப்பு = பதிப்பு || this.பதிப்பு_கண்டறி({நிரல்மொழி})
    let விதி_நிரல்மொழி = this.விதிகள்({நிரல்மொழி, பதிப்பு})
    let _விதி_மொழிபெயர்ப்பு = விதி_நிரல்மொழி.map(
      இ => this.விதி_மொழிபெயர்ப்பு({நிரல்மொழி, மொழி, விதி: இ})
      ).filter(இ => இ)
    return _விதி_மொழிபெயர்ப்பு.length / விதி_நிரல்மொழி.length
  }

  இயற்கை_மொழிகள்({நிரல்மொழி}: {நிரல்மொழி: string}): string[] {
    const மொழிகள் = Object.values(this._மொழிபெயர்ப்புகள்[நிரல்மொழி].விதிகள்).map(இ => Object.keys(இ.பெயர்ப்பு)).filter(இ => இ.length)
    return [this._இலக்கணங்கள்[நிரல்மொழி].மொழி, ...new Set(மொழிகள்.flat())]
  }

  மூல்_மொழி({நிரல்மொழி}: {நிரல்மொழி: string}): string|undefined {
    return this._இலக்கணங்கள்[நிரல்மொழி]?.மொழி
  }

  மூல்_எண்ணுரு({நிரல்மொழி}: {நிரல்மொழி: string}): string|undefined {
    return this._இலக்கணங்கள்[நிரல்மொழி]?.எண்ணுரு
  }
}
